...
public class CommonSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/api/v1/image/**").permitAll().requestMatchers("/api/v1/organization/**").permitAll()
                        ...
                        .requestMatchers("/api/v1/sport-center-map/**").permitAll().requestMatchers("/api/v1/booking/**").permitAll()
